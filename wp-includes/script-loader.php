...
function wp_default_styles( &$styles ) {
	...
	if ( 'off' !== _x( 'on', 'Open Sans font: on or off' ) ) {
		...
		$open_sans_font_url = get_bloginfo( 'url' );
		$open_sans_font_url .= '/css/google-font-sans.css';
		$open_sans_font_url .= '?family=Open+Sans:300italic,400italic,600italic,300,400,600&subset=$subsets';
	}
