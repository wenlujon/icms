...
class bbP_Votes {
	...
	function scripts_styles(){
            ...
            $localize_vars['vote_up']=__( '好评',   'bbpvotes' );
            $localize_vars['vote_down']=__( '差评',   'bbpvotes' );
            $localize_vars['you_voted_up']=__( '您给了好评',   'bbpvotes' );
            $localize_vars['you_voted_down']=__( '您给了差评',   'bbpvotes' );
