...
jq( function() {
	...
	var profileSidebar  = jq("#item-sidebar");
	var profileBottom   = jq("#item-bottom");
	...
	profileSidebar.on("click", ".follow-button a", function() {
		bp_follow_button_action( jq(this), 'article' );
		return false;
    });

	profileBottom.on("click", ".follow-button a", function() {
		bp_follow_button_action( jq(this), 'article' );
		return false;
    });
