...
function bb_follow_and_sidebar_follow_button() {
    $contributor_id = get_the_author_meta( 'ID' );

	//bp_follow_add_follow_button( 'use_default_class=false&leader_id=' . $contributor_id);
	bp_follow_add_follow_button( array('context' => 'article',
                                'leader_id' => $contributor_id) );
}
add_action( 'add_follow_in_sidebar', 'bb_follow_and_sidebar_follow_button' );
