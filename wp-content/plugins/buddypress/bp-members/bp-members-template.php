...
/**
 * Output the displayname submitted during signup.
 */
function bp_signup_displayname_value() {
        echo bp_get_signup_displayname_value();
}
        /**
         * Get the displayname submitted during signup.
         *
         * @todo This should be properly escaped.
         *
         * @return string
         */
        function bp_get_signup_displayname_value() {
                $value = '';
                 ...
                 */
                return apply_filters( 'bp_get_signup_displayname_value', $value );
        }
