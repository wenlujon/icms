...
if ( ! class_exists( 'WpSmushitAdmin' ) ) {
	...
	class WpSmushitAdmin extends WpSmush {
		...
		function screen() {
			global $hook_suffix;
			$admin_page_suffix = add_media_page( 'Bulk WP Smush', '图片优化', 'edit_others_posts', 'wp-smush-bulk', array(
				$this,
				'ui'
			) );
