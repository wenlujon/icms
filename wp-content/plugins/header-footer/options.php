        ...
        <div id="tabs">
            ...
            <div id="tabs-first">
                <table class="form-table">
                    ...
                    <tr valign="top"><?php hefo_field_textarea('home_icon', __('Code to be added as the icon', 'header-footer'), '', 'rows="4"'); ?></tr>
                    <tr valign="top"><?php hefo_field_textarea('home_logo', __('Code to be added as the home logo', 'header-footer'), '', 'rows="4"'); ?></tr>
                    <tr valign="top"><?php hefo_field_textarea('partnership', __('Code to be added as the partnership', 'header-footer'), '', 'rows="10"'); ?></tr>
                    <tr valign="top"><?php hefo_field_textarea('credit', __('Code to be added as the credit', 'header-footer'), '', 'rows="10"'); ?></tr>
                    <tr valign="top"><?php hefo_field_textarea('footer', __('Code to be added before the end of the page', 'header-footer'), '', 'rows="10"'); ?></tr>
            ...
            <div id="tabs-2">
                ...
                <table class="form-table">
                    ...
                    <tr valign="top"><?php hefo_field_textarea('copyright_after', __('Copyright to be inserted after each post', 'header-footer'), '', 'rows="10"'); ?></tr>
                </table>
