...
<div class="togglebox">
  ...
  <tr>
    ...
    <td><input type="number" name="<?php Echo $this->Field_Name('excerpt_thumb_width') ?>" id="<?php Echo $this->Field_Name('excerpt_thumb_width') ?>" value="<?php Echo Esc_Attr($this->Get_Meta('excerpt_thumb_width')) ?>"> px</td>
  </tr>
  <tr>
    <td><label for="<?php Echo $this->Field_Name('excerpt_thumb_height') ?>"><?php Echo $this->t('Thumbnail height') ?></label></td>
    <td><input type="number" name="<?php Echo $this->Field_Name('excerpt_thumb_height') ?>" id="<?php Echo $this->Field_Name('excerpt_thumb_height') ?>" value="<?php Echo Esc_Attr($this->Get_Meta('excerpt_thumb_height')) ?>"> px</td>
  </tr>
  </table>
  <p>
    <input type="checkbox" name="<?php Echo $this->Field_Name('excerpt_thumb_grayscale') ?>" id="<?php Echo $this->Field_Name('excerpt_thumb_grayscale') ?>" value="yes" <?php Checked($this->Get_Meta('excerpt_thumb_grayscale'), 'yes') ?> >
    <label for="<?php Echo $this->Field_Name('excerpt_thumb_grayscale') ?>"><?php Echo $this->t('Convert thumbnails to grayscale.') ?></label>
  </p>
  <p>
    <input type="checkbox" name="<?php Echo $this->Field_Name('excerpt_thumb_negate') ?>" id="<?php Echo $this->Field_Name('excerpt_thumb_negate') ?>" value="yes" <?php Checked($this->Get_Meta('excerpt_thumb_negate'), 'yes') ?> >
  ...
  <p>
    <input type="radio" name="<?php Echo $this->Field_Name('excerpt_template') ?>" id="excerpt_template_<?php Echo Sanitize_Title($properties['file']) ?>" value="<?php Echo Esc_Attr($properties['file']) ?>"
