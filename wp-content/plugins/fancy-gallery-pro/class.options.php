...
class Options {
  private
    ...
    $page_slug = '', # The options page slug
  ...
  public function Add_Options_Page(){
    ...
    $this->Add_Option_Box($this->t('Updates'), DirName(__FILE__).'/options-page/updates.php', 'side');
  }
  ...
  public function Load_Options_Page(){
    ...
    WP_Enqueue_Script('fancy-gallery-options-page', Core::$base_url . '/options-page/options-page.js', Array('jquery'), Core::$version, True);
    WP_Enqueue_Style('fancy-gallery-options-page', Core::$base_url . '/options-page/options-page.css' );
